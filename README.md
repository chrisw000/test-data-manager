...
| `src/Tdm.Core` | Grammar, seeding pipeline, override engine, failure policies, manifest model, benchmark aggregation. No EF references |
| `src/Tdm.EfCore` | EF-model-first entity resolution, repository/faker resolution, persistence routing, lifecycle management, Sqlite/SqlServer provider bootstrap |
